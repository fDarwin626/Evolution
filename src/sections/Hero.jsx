...
<style>{`
      ...
      <div style={{
        ...
        backgroundImage: "repeating-linear-gradient(0deg, rgba(0,0,0,0.035) 0px, rgba(0,0,0,0.035) 1px, transparent 1px, transparent 3px)",
      }} />
      ...
      <div style={{
        ...
        <span className="glitch-hover" style={{
      ...
      <div ref={restRef} style={{ flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{
          ...
          {/* faint synthwave horizon grid, sits behind the shape */}
          <div style={{
            position: "absolute", left: "-50%", right: "-50%", bottom: 0, height: "160%",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
          <a href="/darwin_cv.pdf" download className="glitch-hover" style={{
            fontFamily: "'IBM Plex Mono', monospace",
          ...
          <a href="#Projects" className="glitch-hover" style={{
            fontFamily: "'IBM Plex Mono', monospace",
            fontSize: "9px", letterSpacing: ".16em", textTransform: "uppercase",
...
const DesktopHero = ({ animate }) => {
  ...
  return (
    ...
    <style>{`
      ...
      {/* faint synthwave horizon grid, sits behind the 3D shape */}
      <div style={{
