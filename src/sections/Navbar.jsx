...
const Navbar = () => {
  ...
  return (
    <>
      ...
      py-28 gap-y-10  md:left-1/2 left-1/2">
          <div className="flex flex-col text-4xl gap-y-2 md:text-6xl
          lg:text-8xl">
          ...
          md:flex-row ">
              <div className="font-light">
                ...
                <p className="text-xl tracking-widest lowercase text-pretty">fuoseighadarwin@gmail.com</p>
              </div>
              <div className="font-light">
                <p className="tracking-wider text-white/50">Social platforms</p>
      ...
      w-14 h-14 md:w-20 md:h-20 top-4 right-10" onClick={toggleMenu}
      style={showBurger
